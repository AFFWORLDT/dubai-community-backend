...
const pressReleases = [
  {
    id: 1,
    title: "Primevista Holidayhomes Announces Record Growth in Luxury Property Listings",
    date: "January 5, 2025",
    category: "Company News",
    excerpt: "Primevista Holidayhomes sees 200% year-over-year growth in premium property listings, solidifying its position as Dubai's leading luxury stays platform.",
  ...
  {
    id: 3,
    title: "Primevista Holidayhomes Launches Sustainable Tourism Initiative",
