  ...
  return (
    <>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -left-1 sm:-top-2 sm:-left-2 bg-blue-500 text-white rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs font-medium">
